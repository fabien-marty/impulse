...
def get_html_content(dot: dotfile.DotGraph) -> str:
...
class BrowserGraphViewer(ports.GraphViewer):
    ...
    def view(self, dot: dotfile.DotGraph) -> None:
        html_content = get_html_content(dot)
        # Create a temporary HTML file
        _, html_path = tempfile.mkstemp(
...
class ConsoleGraphViewer(ports.GraphViewer):
    """
    Graph viewer that prints the HTML content to the console.
    """
...
class ConsoleDotViewer(ports.GraphViewer):
    """
    Graph viewer that prints the DOT content to the console.
    """
